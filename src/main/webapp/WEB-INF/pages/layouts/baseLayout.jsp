...
<fmt:message bundle="${locale}" key="baseLayoutPage.title"
	var="baseLayoutPage_title" />
<fmt:message bundle="${locale}" key="baseLayoutPage.menu.greeting"
	var="baseLayoutPage_menu_greeting" />
...
<title>${baseLayoutPage_title}<!-- <bean:message key="locale.linkname.headertitle" />
 -->
</title>
